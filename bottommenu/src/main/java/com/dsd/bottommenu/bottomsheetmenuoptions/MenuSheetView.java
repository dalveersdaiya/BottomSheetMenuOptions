...
import com.dsd.bottommenu.helpers.DisplayHelper;
import com.dsd.bottommenu.helpers.Util;

import java.util.ArrayList;

import static com.dsd.bottommenu.bottomsheetmenuoptions.MenuSheetView.MenuType.GRID;
import static com.dsd.bottommenu.bottomsheetmenuoptions.MenuSheetView.MenuType.LIST;
...
public class MenuSheetView extends FrameLayout {
    ...
    public MenuSheetView(final Context context, final MenuType menuType, @Nullable final CharSequence title, final OnMenuItemClickListener listener) {
        ...
        ViewCompat.setElevation(this, DisplayHelper.convertDpToPx(getContext(), 16f));
    }
    ...
    public void inflateMenu(@MenuRes int menuRes) {
        if (menuRes != -1) {
            @SuppressLint("RestrictedApi") SupportMenuInflater inflater = new SupportMenuInflater(getContext());
    ...
    public void setTextDescription(String textDescription, int pos) {
    }
...
//                    icon.setVisibility(VISIBLE);
                    Drawable drawable = item.getMenuItem().getIcon();
                    label.setCompoundDrawablesWithIntrinsicBounds(null, null, drawable, null);
                }
            }
        }
    }
